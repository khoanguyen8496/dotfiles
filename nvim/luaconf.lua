...
if vim.fn.exists('g:loaded_telescope') then
	...
	vim.api.nvim_set_keymap('n', '<F6>', ':Telescope find_files<cr>', {})
	vim.api.nvim_set_keymap('n', '<F5>', ':Telescope<cr>', {})
	vim.api.nvim_set_keymap('n', '<F3>', ':Telescope grep_string<cr>', {})
	vim.api.nvim_set_keymap('n', '<F10>', ':Telescope resume<cr>', {})
end
